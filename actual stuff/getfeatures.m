...
solidity = regionprops(ImageBW, 'solidity');
solidityvec = struct2cell(solidity);
soliditymat = cell2mat(solidityvec);
...
conv = regionprops(ImageBW, 'ConvexArea');
convcell = struct2cell(conv);
convmat = cell2mat(convcell);
convmean = mean(convmat);
